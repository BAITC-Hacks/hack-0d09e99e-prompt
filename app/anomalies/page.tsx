import { anomalies, formatQty } from "../data/catalog";

export default function AnomaliesPage() {
  return (
    <section className="card overflow-hidden">
      <header className="border-b border-line p-4">
        <h1 className="text-2xl font-semibold tracking-tight text-ink">Исключённые разовые заказы</h1>
        <p className="mt-1 text-[13px] text-ink-secondary">
          Расходные накладные из «Динамика продаж»: количество ≥ 1000 и ≥ 8 медиан SKU. В регулярный спрос не входят.
        </p>
      </header>
